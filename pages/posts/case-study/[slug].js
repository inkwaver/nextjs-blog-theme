        ...
        <main className="single-content wrapper-main">
          <article className="content">
            ...
            <div className="next-prev-posts">
              {prevPost && (
                <Link className="prev-post" href={`/posts/case-study/${prevPost.slug}`}>
              ...
              {nextPost && (
                <Link className="next-post" href={`/posts/case-study/${nextPost.slug}`}>
                  <span className="thumb-holder">
                    {nextPost.thumbnail && (
                      <Image
...
export const getStaticProps = async ({ params }) => {
  ...
  const { mdxSource, data } = await getPostBySlug(slug, 'case-study');
